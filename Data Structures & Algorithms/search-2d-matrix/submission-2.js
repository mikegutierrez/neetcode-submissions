class Solution {
    ...
    searchMatrix(matrix, target) {
        ...
        while (left <= right) {
            ...
            // dividing the flat index by the row length tells 
            // how many complete rows fit before this index
            const row = Math.floor(mid / n);

            // the remainder after dividing by row length tells 
            // how far into the current row you are
            const col = mid % n;
